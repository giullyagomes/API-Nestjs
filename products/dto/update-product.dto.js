...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Product price', required: false }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Product stock quantity', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Product category', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Is product active', required: false }),
    (0, class_validator_1.IsOptional)(),

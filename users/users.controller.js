...
let UsersController = class UsersController {
    ...
    update(id, updateUserDto, user) {
        if (user.role !== role_enum_1.Role.ADMIN && user.id !== id) {
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'The user has been successfully created.', type: user_entity_1.User }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return the user profile.', type: user_entity_1.User }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'The user has been successfully updated.', type: user_entity_1.User }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'User not found.' }),
    __param(0, (0, common_1.Param)('id')),
